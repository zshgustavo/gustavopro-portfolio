 ...
 *
 * Order: LinkedIn, GitHub, Website, Gravatar, GDG Cloud Brasília, Last.fm.
 * Icon paths come from the approved Claude Design proposal.
 */
...
const SOCIALS = [
  ...
  },
  {
    ...
    icon: 'M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0',
  },
  {
    id: 'lastfm',
    label: 'Last.fm',
...
function SocialIcons({ iconSize = 20 }) {
  return (
    <>
